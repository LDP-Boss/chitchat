// ============================================================================
// KINDRED CHAT — CONFIGURATION
//
// Replace the two values below with YOUR Supabase project's URL and anon
// (public) key. Find them in your Supabase dashboard:
//   Project → Settings → API → "Project URL" and "anon public" key
//
// It is safe to expose the anon key in frontend code — it is protected by
// the Row Level Security policies created in supabase-schema.sql.
